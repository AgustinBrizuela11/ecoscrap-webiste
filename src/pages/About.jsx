          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                En Eco Scrap, nos dedicamos a proporcionar soluciones sostenibles de reciclaje y gestión 
                de residuos metálicos, contribuyendo a la conservación del medio ambiente y promoviendo 
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Ser líderes en la industria del reciclaje de metales, estableciendo nuevos estándares 
